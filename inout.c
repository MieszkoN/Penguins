...
void printMessage(int result)
{
	...
	{  
		...
		case CAN_NOT_MAKE_ANY_MOVE:  printf("The penguin cannot make any movement!\n"); break;
        ...
        case GENERATING_BOARD_FAILURE: printf("Generating board failed.\n"); break;

        case GENERATING_BOARD_SUCCESS: printf("Generating board successful.\n"); break;

        case LOADING_DATA_FAILURE: printf("Loading data from file failed.\n"); break;

        case LOADING_DATA_SUCCESS: printf("Data successfully loaded.\n"); break;

        case WRONG_CMD_PARAMETERS: printf("Wrong command line parameters.\n"); break;

        case PLACEMENT_FAILURE: printf("Placement failed.\n"); break;

        case PLACEMENT_SUCCESS: printf("Placement successful.\n"); break;
	}  
}
